...
class BlogAuthorModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        testuser10 = User.objects.create_user(username='testuser10', password='testpassword')
        testuser10.save()
        BlogAuthor.objects.create(name=testuser10, bio='This is a bio')
    ...
    def test_object_name(self):
        author=BlogAuthor.objects.get(id=1)
        expected_object_name = author.name.username
...
class BlogModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        testuser10 = User.objects.create_user(username='testuser10', password='testpassword')
        testuser10.save()
        blog_author = BlogAuthor.objects.create(name=testuser10, bio='This is a bio')
...
class BlogCommentModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        testuser10 = User.objects.create_user(username='testuser10', password='testpassword')
        testuser10.save()
        testuser20 = User.objects.create_user(username='testuser20', password='testpassword')
        testuser20.save()
        blog_author = BlogAuthor.objects.create(name=testuser10, bio='This is a bio')
        blog_test = Blog.objects.create(name='Test Blog 1',author=blog_author,description='Test Blog 1 Description')
        blog_comment=BlogComment.objects.create(description='Test Blog 1 Comment 1 Description', author=testuser20,blog=blog_test)
